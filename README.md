...
>
> **We'd love your feedback!** Please share any suggestions, bug reports, feature requests, or general thoughts by [filing an issue](https://www.github.com/with-ours/ingest-sdk-php/issues/new).
...
```json
{
  "repositories": [
    {
      "type": "vcs",
      "url": "git@github.com:with-ours/ingest-sdk-php.git"
    }
  ],
  "require": {
