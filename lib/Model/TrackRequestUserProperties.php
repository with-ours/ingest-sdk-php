...
/**
 * TrackRequestUserProperties Class Doc Comment
 *
 * @category Class
 ...
 */
class TrackRequestUserProperties implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'track_request_userProperties';
    ...
    */
    ...
    public function setEmail($email)
    {
        ...
        if (!is_null($email) && (mb_strlen($email) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $email when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setFirstName($first_name)
    {
        ...
        if (!is_null($first_name) && (mb_strlen($first_name) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if (!is_null($last_name) && (mb_strlen($last_name) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setGender($gender)
    {
        ...
        if (!is_null($gender) && (mb_strlen($gender) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $gender when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setDateOfBirth($date_of_birth)
    {
        ...
        if (!is_null($date_of_birth) && (mb_strlen($date_of_birth) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $date_of_birth when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $city when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setState($state)
    {
        ...
        if (!is_null($state) && (mb_strlen($state) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $state when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $country when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setExternalId($external_id)
    {
        ...
        if (!is_null($external_id) && (mb_strlen($external_id) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $external_id when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if (!is_null($company_name) && (mb_strlen($company_name) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setJobTitle($job_title)
    {
        ...
        if (!is_null($job_title) && (mb_strlen($job_title) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $job_title when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
    ...
    public function setIp($ip)
    {
        ...
        if (!is_null($ip) && (mb_strlen($ip) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $ip when calling TrackRequestUserProperties., must be smaller than or equal to 2000.');
        }
